...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponseWrapper<List<ProductDetails>>> fetchAllProducts() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponseWrapper<ProductDetails>> fetchProductById(@PathVariable Long id) {
    ...
    @ApiResponse(responseCode = "201", description = "Product created successfully",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponseWrapper.class)))
    @PostMapping
    public ResponseEntity<ApiResponseWrapper<ProductDetails>> addNewProduct(@RequestBody ProductDetails productDetails) {
    ...
    @ApiResponse(responseCode = "201", description = "Catalog created successfully",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponseWrapper.class)))
    @PostMapping("/catalog")
    public ResponseEntity<ApiResponseWrapper<ProductCatalog>> addNewCatalog(@RequestBody ProductCatalog catalog) {
    ...
    public ResponseEntity<ApiResponseWrapper<List<ProductDetails>>> fetchProductByCatalog(@PathVariable String catalogName) {
    ...
    public ResponseEntity<ApiResponseWrapper<ProductDetails>> updateProductDetails(
    ...
    public ResponseEntity<ApiResponseWrapper<ProductDetails>> updateProductCatalog(
            @PathVariable Long productId,
    ...
    public ResponseEntity<ApiResponseWrapper<ProductDetails>> updateStocksForProductById(
    ...
    public ResponseEntity<ApiResponseWrapper<String>> deleteProductById(@PathVariable Long productId) {
